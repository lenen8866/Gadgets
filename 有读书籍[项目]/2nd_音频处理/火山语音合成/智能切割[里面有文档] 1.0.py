...
def process_txt_file(file_name, input_file, output_file, flag=False):
    # 打开文件
...
def main():
    ...
    for file in os.listdir(input_folder):
        if file.endswith(".txt"):
            ...
            process_txt_file(file, input_file, output_file)
    ...
    for file in os.listdir(input_folder):
        if file.endswith(".txt"):
            input_file = os.path.join(input_folder, file)
            output_file = os.path.join(output_folder, file[:-3] + "mp3")
            process_txt_file(file, input_file, output_file, True)
    deal_async_task()
